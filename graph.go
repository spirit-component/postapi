...
// 		errPortsConfig := graphConf.GetConfig("error")
...
// 		entrypointConfig := graphConf.GetConfig("entrypoint")

// 		var entrypointPorts []*protocol.Port
// 		entrypointPorts, err = p.configToPorts(apiKey, portsConfig)
